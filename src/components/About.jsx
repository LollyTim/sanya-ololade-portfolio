      ...
      <div className="  flex flex-col gap-6 lg:w-[80%] w-[90%] mx-auto">
        <div className=" w-full lg:grid lg:grid-cols-5 lg:auto-cols-[300px] gap-6">
          <motion.div
            ...
            className=" dark:bg-darkgbg bg-lightgbg py-5 px-8 lg:col-span-3 w-full  rounded-xl flex flex-col lg:gap-2 gap-4  "
          >
          ...
          <motion.div
            ...
            className="dark:bg-darkgbg bg-lightgbg justify-center lg:col-span-2 items-center flex rounded-xl"
          >
        ...
        <div className=" w-full lg:grid lg:grid-cols-5 lg:auto-cols-[300px] gap-6 ">
          <div className=" w-full lg:grid lg:grid-cols-2 flex lg:auto-cols-[300px] gap-6 flex-row mb-6 lg:mb-0  lg:col-span-2 lg:gap-6 ">
            <motion.div
              ...
              className=" rounded-2xl dark:bg-darkgbg bg-lightgbg flex flex-col justify-center w-full items-center"
            >
        ...
        <div className=" md:w-full flex flex-col md:grid md:grid-cols-5 md:auto-cols-[200px] gap-6 ">
          <motion.div
            ...
            className=" gap-2 rounded-2xl dark:bg-darkgbg bg-lightgbg md:col-span-2 flex py-2 px-4 justify-center items-center"
          >
          ...
          <motion.div
            ...
            className=" rounded-2xl dark:bg-darkgbg bg-lightgbg md:col-span-2 flex justify-center items-center gap-4 py-2 px-5"
          >
            {Stack.map((each, id) => (
              <div key={id}>
                <img
          ...
          <motion.div
            ...
            className=" rounded-2xl dark:bg-darkgbg bg-lightgbg h-[160px] gap-3 justify-center items-center flex px-2 pt-3"
          >
            <div className=" flex flex-col justify-center items-center">
              <img src={Mongodb} alt="" className="flex size-8" />
              <p className=" text-textClr dark:text-textClrDark">M</p>
            </div>
            <div className=" flex gap-1 flex-col justify-center items-center">
              <h1 className=" text-textClr dark:text-textClrDark text-center flex text-xl ">
                ex
              </h1>
              <p className=" text-textClr dark:text-textClrDark">E</p>
            </div>
            <div className=" flex flex-col justify-center items-center">
              <img src={ReactJs} alt="" className="flex size-8" />
              <p className=" text-textClr dark:text-textClrDark">R</p>
            </div>
            <div className=" flex flex-col justify-center items-center">
              <img src={NodeJs} alt="" className="flex size-8" />
              <p className=" text-textClr dark:text-textClrDark">N</p>
            </div>
          </motion.div>
        </div>
      </div>
